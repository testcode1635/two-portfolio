        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }, faqIndex) => (
            ...
            >
              <div
                className={twMerge(
                  "absolute h-0 bottom-0 left-0 w-full bg-stone-300 -z-10 group-hover/faq:h-full transition-all duration-700",
              ...
              >
                ...
                <div
                  className={twMerge(
                    "inline-flex items-center justify-center size-11 border border-stone-400 rounded-full shrink-0 transition-all duration-300 bg-stone-300",
